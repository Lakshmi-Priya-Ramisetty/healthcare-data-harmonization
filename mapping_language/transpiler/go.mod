module github.com/Lakshmi-Priya-Ramisetty/healthcare-data-harmonization/mapping_language/transpiler
...
require (
    ...
    github.com/Lakshmi-Priya-Ramisetty/healthcare-data-harmonization/mapping_language v0.0.0-00010101000000-000000000000
